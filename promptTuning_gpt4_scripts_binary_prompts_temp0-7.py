...
def main():
    ...
    file_name = "gpt4-preview_zero_shot_all_metrics_helpful_assistant_temp0-7_binary_task.csv"
    log_file_name = "gpt4-preview_zero_shot_all_metrics_helpful_assistant_temp0-7_binary_task"
